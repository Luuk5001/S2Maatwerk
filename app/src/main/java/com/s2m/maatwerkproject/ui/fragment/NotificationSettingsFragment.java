...
public class NotificationSettingsFragment extends ListFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        setListAdapter(new VariableAndroidListItemAdapter(view.getContext(), AppSettings.getSettingsArray(Setting.SettingType.Notification)));
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        //TODO start dialogs
        switch ((int)id){
            case AppSettings.SOUND_SETTING_ID:
                break;
            case AppSettings.VIBRATION_SETTING_ID:
                break;
            case AppSettings.LED_SETTING_ID:
                break;
        }
    }
}
